...
\nomenclature{$Y_j$}{Type of instance $I_j$. Each type represents a certain configuration of CPU, memory, disk space and network speed.}
\nomenclature{$S$}{A schedule that maps tasks to instances that can process the tasks}
